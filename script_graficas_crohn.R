...
palabras_no_deseadas <- c("Macao", "Puerto Rico")
...
png("/Users/paula/Documents/Duponte/graficas_r/crohn_grafo_scopus.png", width = 2000, height = 1500, res = 300)  # Ajusta width, height y res según tus necesidades
...
datos_dfpaises=paste(datos_df$paises)

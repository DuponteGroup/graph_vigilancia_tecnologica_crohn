...
library(viridis)
install.packages
archivo= ('/Users/paula/Documents/Duponte/graficas_r/scopus_CROHN.csv')
...
datos_df$paises=sub("Macao", "China", datos_df$paises) 
datos_df$paises=sub("Puerto Rico", "United States", datos_df$paises) 
...
png("/Users/paula/Documents/Duponte/graficas_r/crohn_grafo_scopus.png", width = 3000, height = 2000, res = 300)  # Ajusta width, height y res según tus necesidades
...
png("/Users/paula/Documents/Duponte/graficas_r/crohn_produccion_paises.png", width = 2500, height = 2500, res = 300)  # Ajusta width, height y res según tus necesidades
df_summary %>% 
  #filter(Production > 1) %>% 
